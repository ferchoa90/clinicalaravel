                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <div class="row col">
                                <div class="d-flex ">
                                    <a class="btn btn-info btn-xs  " href="{{route('patient.edit',[$paciente])}}" title="Editar Paciente">
                                        <i class="fa fa-edit"></i>
                                    </a>&nbsp;&nbsp;&nbsp;
                                     
                                    @if ($paciente->status == 1)
                                    <form action="{{route('patient.inactive', [$paciente])}}" method="post">
                                        @csrf
                                    ...
                                    @else
                                    <form action="{{route('patient.active', [$paciente])}}" method="post">
                                        @csrf
                                    ...
                                    @endif
                                    <form action="{{route('patient.fichamedica', [$paciente])}}" method="post">
                                       
                                        @csrf
                                        <button class="btn btn-info btn-xs" type="submit" title="Ficha médica">
                                            <i class="fa fa-list"></i>
                                        </button>&nbsp;&nbsp;&nbsp;
                                    </form>

                                    <form action="{{route('patient.destroy', [$paciente])}}" method="post">
                                        @method("delete")
                                        @csrf
                                        <button class="btn btn-danger btn-xs" type="submit" title="Eliminar paciente">
