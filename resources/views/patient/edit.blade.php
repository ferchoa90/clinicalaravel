                ...
                <div class="row pb-5 pt-5 pl-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            ...
                            <input required autocomplete="off" name="email"  value="{{$patient->email}}" class="form-control" type="email"
                                placeholder="Correo electrónico">
                        </div>

                        <div class="col-3">
                            <label class="label">*Inmunizaciones:</label>
                            <select class="form-control" name="inmunizations">
                                <option value="-1">Seleccionar Respuesta</option>
                                <option value="1" @if ($patient->inmunizations==1) selected="" @endif>Si</option>
                                <option value="0" @if ($patient->inmunizations==0) selected="" @endif>No</option>
                            </select>
                        </div>
                        <div class="col-3">
                            ...
                            <select class="form-control" name="allergy">
                                <option value="-1">Seleccionar Respuesta</option>
                                <option value="1" @if ($patient->allergy==1) selected="" @endif  >Si</option>
                                <option value="0" @if ($patient->allergy==0) selected="" @endif>No</option>
                            </select>
                        </div>
                        <div class="col-6">
                            <label class="label">*Alergias:</label>
                            <input required autocomplete="off" name="allergies"  value="{{$patient->allergies}}" class="form-control" type="text"
