            ...
            <div class="card bg-warning invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        ...
                        <span class="text-white fs-18">Total Pacientes</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-success invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        ...
                        <span class="text-white fs-18">Total Doctores</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-xxl-3 col-sm-6">
            <div class="card bg-info invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num">5</h2>
                        <span class="text-white fs-18">Citas Hoy</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card-bx bg-blue">
                                ...
                                <div class="card-info text-white">
                                    ...
                                    <h2 class="text-white card-balance">$6785</h2>
                                    <p class="fs-16">Atenciones mensuales</p>
                                    <span>+0,8% más que el mes anterior</span>
                                </div>
                            ...
                            <div class="row  mt-xl-0 mt-4">
                                <div class="col-md-6">
                                    ...
                                    <ul class="card-list mt-4">
                                        <li><span class="bg-blue circle"></span>Cuentas<span>20%</span></li>
                                        <li><span class="bg-success circle"></span>Clientes<span>40%</span></li>
                                        <li><span class="bg-warning circle"></span>Citas<span>15%</span></li>
                                        <li><span class="bg-light circle"></span>Recaudaciones<span>15%</span></li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
